...
public static class DbInitializer
{
    ...
    public static async Task InitializeAsync(ApplicationDbContext context)
    {
        ...
        {
            new() { Id = loc1, Name = "Oven 1", Publish = true ,Path = "Local Station/Channel1/Device1"},
            new() { Id = loc2, Name = "Oven 2", Publish = true ,Path = "Local Station/Channel2/Device1"},
            new() { Id = loc3, Name = "Oven 3", Publish = false ,Path = "Local Station/Channel3/Device1"}
        };
        ...
        {
            new() { LocationId = loc1, Temperature = 245.5,Path = "Local Station/Channel1/Device1" },
            new() { LocationId = loc2, Temperature = 252.0,Path = "Local Station/Channel2/Device1" }
        };
